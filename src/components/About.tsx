...
export default function About() {
  ...
  return (
    <section className="w-full bg-white text-zinc-900 py-32 px-4 md:px-12 -mt-4  md:mt-0 flex flex-col items-center justify-center  relative h-[80vh] font-jakarta">
